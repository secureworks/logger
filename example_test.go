...
func Example() {
	...
	// // Optional custom options, passing nothing for this is fine, look
	// // to log.CustomOption for more info:
	// var opts []log.Option
	...
	// ... or create new http.Server with logger as base context for use
	// by request handlers and ErrorLog set to write to logger at WARN
	// level.
